        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-primary-foreground/60 hover:text-ember-glow transition-colors">
              ...
              <a href="https://www.instagram.com/routenterprises2001" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-primary-foreground/60 hover:text-ember-glow transition-colors">
