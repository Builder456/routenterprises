              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-1">
                    <a href="https://www.linkedin.com/company/rout-enterprises.steel/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-ember transition-colors">
                    ...
                    <a href="https://www.instagram.com/routenterprises2001" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-ember transition-colors">
